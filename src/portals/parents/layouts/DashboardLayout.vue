...
const navItems = [
  { label: 'Dashboard', route: { name: 'ParentDashboard' } },
  { label: 'Student Information', route: { name: 'ParentStudent' } },
  { label: 'Attendance Records', route: { name: 'ParentAttendance' } },
  { label: 'Finance' ,
     children: [
      { label: 'Fee Overview', route: { name: 'ParentFeeSummary' } },
      { label: 'Fee Statement', route: { name: 'ParentFeeStatements' } },
      { label: 'Fee Structure', route: { name: 'ParentFeeStructure' } },
