  ...
  <div class="min-h-screen bg-slate-50">
    <div class="max-w-5xl mx-auto px-4 py-6 sm:py-8">
      ...
      <div class="mb-6">
        ...
        <p v-if="admissionNumber" class="text-sm text-slate-500 mt-1">
...
// Passed from ClassRollCall.vue when the principal clicks a student
// row, purely for display — avoids a second lookup call.
const studentName = route.query.studentName || ''
const admissionNumber = route.query.admissionNumber || ''
...
const fetchAttendance = async () => {
  ...
  try {
    ...
    const res = await fetchStudentAttendanceCalendar(props.studentId)
...
function goBack() {
  ...
  if (route.query.fromClass) {

    router.push({
      name: 'ClassRollCall',
      params: { classInstanceId: route.query.fromClass },
      query: { date: route.query.fromDate },
    })
